...
using DomasnaIS.Repository.Implementation;
using DomasnaIS.Domain;
using DomasnaIS.Service;
using DomasnaIS.Service.Interface;
using DomasnaIS.Service.Implementation;
using Stripe;
...
namespace DomasnaIS
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IOrderService, DomasnaIS.Service.Implementation.OrderService>();
